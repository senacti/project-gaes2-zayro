...
<body>
    ...
    <div class="sidebardas">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="inventario.html" class="active"><span class="fas fa-table"></span>
    ...
    <div class="main-wrapper">
        <div class="main-content">
            <header>
                <img src="<?php echo e(asset("images/logo2.png")); ?>" alt="" width="80px"
                ...
                <div class="user-wrapper">
                    <img src="<?php echo e(asset("images/logo1.png")); ?>" alt="">
                    <div>
                        <h4>Olga D'aleman</h4>
                ...
                <div class="cards">
                    ...
                    <div class="card-single">
                        <div>
                            ...
                            <span>Registros se deben respaldar en la copia de seguridad</span>
                        </div>
                        <div>
...
</html><?php /**PATH C:\Users\Usuario\Documents\GitHub\project-gaes2-zayro\laravel\resources\views/inventario.blade.php ENDPATH**/ ?>